...
@Autonomous(name = "HeartsAutonomusLeft")
public class HeartsAutonomusLeft extends LinearOpMode {
    ...
    private void ONE_CUBE_CAMERA_DIAG_1() {
        ...
        sleep(1000);
        lift_move(1);
        forward_backward_left_right(104.5, "r");
        sleep(500);
        ...
        lift_move(0);
        claw_close(true);
        forward_backward_left_right(36, "l");
        sleep(500);
        if (square_to_move_robot == 1) {
            forward_backward_left_right(63, "f");
        } else if (square_to_move_robot == 3) {
            forward_backward_left_right(60, "b");
        } else {
        }
    }
    ...
    private void lift_move(int lift_pos) {
        ...
        m_left.setTargetPosition(2700);
        m_right.setTargetPosition(2700);
